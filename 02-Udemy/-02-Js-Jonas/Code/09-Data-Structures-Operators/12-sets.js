...
//
const ordersSets = new Set(['Pasta', 'Pizza', 'Pizza', 'Risotto', 'Pasta']);
console.log(ordersSets);
console.log(new Set('Sayed'));
console.log(ordersSets.size);
console.log(ordersSets.has('Pizza'));
console.log(ordersSets.has('flafel'));
ordersSets.add('egg');
ordersSets.add('egg');
ordersSets.delete('Risotto');
// ordersSets.clear //delete all elements
console.log(ordersSets);

for (const x of ordersSets) console.log(x);

const staff = ['Waiter', 'Chef', 'Manager', 'Chef', 'Waiter'];
const staffUnique = [...new Set(staff)];
// staffUnique now is array with unique values but if ww delete spreed operator(...)it will be set
